...
#define BOOT_PARAMETER_TABLES_BASE					(0x43c3f298)
#define MMC_BOOT_PARAMETER_TABLES_RAWINDES			(416)
#define FLASH_BOOT_PARAMETER_TABLES_RAWINDES		(292)
#define TI_AM62X_MMC_BOOT_PART_INDEX				(BOOT_PARAMETER_TABLES_BASE + MMC_BOOT_PARAMETER_TABLES_RAWINDES)
#define TI_AM62X_FLASH_BOOT_PART_INDEX				(BOOT_PARAMETER_TABLES_BASE + FLASH_BOOT_PARAMETER_TABLES_RAWINDES)
#endif
